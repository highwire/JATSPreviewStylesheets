    ...
    <a>
      <xsl:choose>
        <xsl:when test="(@xlink:href and starts-with(@xlink:href,'atom://'))">
          ...
          <xsl:variable name="queryURL" select="concat('http://atom.highwire.org/svc.atom?query-form=search&amp;canned-query=/hwc/extended-queries/get.xqy&amp;corpus=',$corpus,'&amp;element=atom:id&amp;element-value=',$atomID)"/>
